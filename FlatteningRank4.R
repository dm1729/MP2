function <- FlatteningRank4(P) #Input a PMF for a 4 dimensional binary model (16 masses)
...
#r <- max(rankMatrix(A),rankMatrix(B),rankMatrix(C)) #finds maximum rank (built in tolerance seems like)
#return(r)
